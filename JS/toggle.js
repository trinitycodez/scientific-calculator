"use strict";
const toggleDarkLight = document.querySelector(".dark");
...
const resultDisplay = document.querySelector(".result-class");
const sideOptr = document.querySelector(".sideOptr");
